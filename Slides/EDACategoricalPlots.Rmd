...
Statisticians rarely use pie charts, but they are popular in media.

“There is no data that can be displayed in a pie chart that cannot be displayed better in some other type of chart.”

(*Some people attribute this quote to John Tukey. While it cannot be verified, it is generally a true statement.*)

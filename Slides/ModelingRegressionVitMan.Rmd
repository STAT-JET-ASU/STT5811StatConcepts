---
title: "Regression Models: The<br>Vitruvian Man Example"
...
knitr::include_graphics("images/VitManEdited800.jpg")
```
...
```{r, echo = FALSE, fig.align="center"}
knitr::include_graphics("images/magnifyingglass.png", dpi = 600)
```

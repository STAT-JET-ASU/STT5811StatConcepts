---
title: "Numerical Data:<br>Center, Spread, Z-Scores"
...
While not strictly mathematically true, it is helpful to think of SD as roughly the average distance of all points from the mean. Its units are the same as the mean and the actual data values.

...
Now let's explore! Log in to the [Appalachian Rstudio server](https://mathr.math.appstate.edu/).


## What are R and RStudio?

* `R` is a programming language that runs computations
* RStudio is an integrated development environment (IDE); it is a user interface that makes it easier for us to interact with `R`

<p style="text-align:center; font-size: 18px;"><img src="https://d33wubrfki0l68.cloudfront.net/0b4d0569b2ddf6147da90b110fbb2a17653c8b08/f06f3/images/shutterstock/r_vs_rstudio_1.png" width = 775><br>Analogy of the difference between `R` and RStudio (from [ModernDive](https://moderndive.com/1-getting-started.html))</p>
...
RStudio isn't the only IDE for R, but it is one of the most widely used. Like  [ModernDive](https://moderndive.com/v2/getting-started.html) says, R is like the engine and RStudio is the dashboard that lets us drive that car where we want to go. We can also add packages to "soup up" our engine.
...
There are four "[panes](https://docs.posit.co/ide/user/ide/guide/ui/ui-panes.html)" in the RStudio interface.
...
**One of our goals in this class will be to learn *how* to learn...**
...
But I can tell you from past experience that most students succeed if they come and engage with an open mind.

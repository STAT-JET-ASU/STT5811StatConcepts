...
NOTE: Faceting has newer syntax for specifying variables. See [`facet_grid()`](https://ggplot2.tidyverse.org/reference/facet_grid.html) and [`facet_wrap()`](https://ggplot2.tidyverse.org/reference/facet_wrap.html) reference pages.

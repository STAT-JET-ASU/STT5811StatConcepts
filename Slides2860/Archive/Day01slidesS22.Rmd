---
title: "STT2860 Introduction<br>to Data Management<br>and Visualization---Day 1"
...
<p style="text-align: center;"><img src = "../images/developed-a-theory-nerd.jpg" height=525;></p>
...
The Chapel was acquired by Rensselaer in 1958 and renovated into a library in 1960. It was transformed into the VCC in 1976. President [George Low](https://www.smithsonianmag.com/air-space-magazine/apollo-8-george-low-profile-180970807/) said it was "the most unique computing center in the world." (There was a definitely a *lot* of invoking of deities, in my experience...)

## Multidisciplinary Data Science!

<img src = "http://i.imgur.com/aoz1BJy.jpg" width = 775/>

Where are you in this diagram? Open up [Poll Everywhere](https://pollev.com/jillthomley851) so we can explore this.
...
<p>Note: This table was created and formatted using RMarkdown. All of the slides were. These are among the things you will learn how to do in this class.
...
* Finally, complete "Confirm DataCamp account creation" on AsULearn.
...
Shortly we will switch over to the [course syllabus](https://stat-jet-asu.github.io/IntroDataManagementVis/SyllabusSchedule/STT2860S22Syllabus.html) and talk some more about objectives and assessments.
...
Weeks where you have a full DataCamp course, that will take up about four hours of time.

There are no prerequisites other than some basic mathematics proficiency for this course. Students are not expected to have statistics or programming experience. If you do come into the course with one or both, you **may** not require as much time to master course concepts, but do not assume until you try. 
